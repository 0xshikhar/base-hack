...
export default function GroupPage() {
    ...
    return (
        <div className="p-10 px-10">
            ...
            <div className="summary">you must first prove that you have a valid twitter account </div>

            <div className="summary">
                You need to obtain a{" "}
                <a href="https://tlsnotary.org" target="_blank" rel="noreferrer noopener nofollow">
                    TLSNotary
                </a>{" "}
            ...
            <div className="banner-container">
                <Image src="/tlsn-banner.png" alt="tlsn logo" width={500} height={200} priority={true} />
            </div>

            <div className="summary">Then, submit the attestation file below.</div>
            ...
            <div>
                ...
                />
                <button className="button" type="submit" disabled={_loading || _submitted} onClick={triggerFileInput}>
                    <span>{!_submitted ? (_loading ? "Uploading..." : "Upload TLSN Attestation") : "Submitted!"}</span>
                </button>
            ...
            <Stepper step={2} onPrevClick={() => router.push("/")} />
        </div>
    )
}
